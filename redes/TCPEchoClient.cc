...
const uint32_t RCVBUFSIZE = 3500;    // Size of receive buffer; 3500 es un tamaño aceptable para la gran mayoria del codigo fuente de una página web.Un valor menor podria cortar el mensaje en pantalla
